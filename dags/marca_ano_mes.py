...
dag = DAG("sales_consolidated_marca_ano_mes", default_args=default_args, schedule_interval=timedelta(1))
...
def insert_data(**kwargs):
    ...
    df.to_sql('sales_consolidated_marca_ano_mes', engine, index=False,if_exists='append')


with DAG('sales_consolidated_marca_ano_mes',
